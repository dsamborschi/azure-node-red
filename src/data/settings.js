...
module.exports = {
    ...
    onruntimeevent: function(event) {
        console.log("[DEBUG] onruntimeevent triggered:", event.type);
        if (event.type === "flows:deployed") {
            console.log("Flows were deployed at:", new Date().toISOString());
        }
    },
